        ...
        if sData.find("GGA")>0:
            ...
            try:
                ...
                if latitude == 0 and longitude == 0:
                    ...
                    latitude = 0.9*latitude + 0.1*GpggaParseResult.latitude
                    longitude = 0.9*longitude + 0.1*GpggaParseResult.longitude
    ...
    while g_startSamplingDistflag == True:
        ...
        if sData.find("GGA")>0:
            ...
            if latitude == 0 and longitude == 0:
                ...
                latitude = 0.9 * latitude + 0.1 * sParseResult.latitude
                longitude = 0.9 * longitude + 0.1 * sParseResult.longitude
...
def fnStoreData(lock, GpggaBuffer, DptBuffer):
    ...
    try:
        with open('echologger7.csv', 'a+', newline = '') as echologger:
            #proses dequeueing
